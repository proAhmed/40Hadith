# الاربعون النووية Privacy policy
Welcome to the الاربعون نووية app for Android!

This is an open source Android app developed by Ahmed Radwan. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
